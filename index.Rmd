...
```{r}
hm <- read_csv("data/housing_metrics_clean")

hm %>% 
  filter(beds == 1) %>% 
  group_by(city) %>% 
  summarise(Number_of_listings = n(),
            Median_home_value = median(price),
            Avg_sq_ft = mean(sq_ft),
            Avg_Price_per_sqft = Median_home_value / Avg_sq_ft) %>% 
  kableExtra::kable() %>% kable_styling(latex_options = "striped")
```
...
![](./final_project/Screen Shot 2021-12-15 at 12.55.35 AM.png)
...
![](./final_project/Screen Shot 2021-12-15 at 1.06.22 AM.png)
![](./final_project/Screen Shot 2021-12-15 at 1.06.41 AM.png)
![](./final_project/Screen Shot 2021-12-15 at 1.07.04 AM.png)
...
![](./final_project/Screen Shot 2021-12-15 at 1.50.49 AM.png)
![](./final_project/Screen Shot 2021-12-15 at 1.51.16 AM.png)
![](./final_project/Screen Shot 2021-12-15 at 1.51.27 AM.png)
